...
class PageService
{
    ...
    private function formatBlog($blog)
    {
        return [
            ...
            'mobile_banner_image' => $blog->mobile_banner_image,
            'mobile_banner_image_alt' => $blog->mobile_banner_image_alt,
            'image' => $blog->image,
            'image_alt' => $blog->image_alt,
            'mobile_image' => $blog->mobile_image,
            'mobile_image_alt' => $blog->mobile_image_alt,
