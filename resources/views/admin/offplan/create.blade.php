...
@section('content')
    <div class="container mt-5">
        ...
        <form action="{{ route('admin.offplan.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-3">
                ...
                <div id="near_by_repeater">
                    <div class="near_by_item">
                        ...
                        <input type="number" step="0.1" class="form-control mb-2" name="near_by[0][distance]"
