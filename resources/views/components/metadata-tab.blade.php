            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" id="meta_description" name="metadata[meta_description]" rows="3">{{ old('metadata.meta_description', $model?->metadata?->meta_description ?? '') }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @error('metadata.og_image')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                        @if(isset($model) && $model->metadata?->og_image)
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" id="og_description" name="metadata[og_description]" rows="3">{{ old('metadata.og_description', $model?->metadata?->og_description ?? '') }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @error('metadata.twitter_image')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                        @if(isset($model) && $model->metadata?->twitter_image)
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" id="twitter_description" name="metadata[twitter_description]" rows="3">{{ old('metadata.twitter_description', $model?->metadata?->twitter_description ?? '') }}</textarea>
